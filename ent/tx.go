...
func (tx *Tx) init() {
	tx.ApiConfig = NewApiConfigClient(tx.config)
	tx.TaxonomyVocabulary = NewTaxonomyVocabularyClient(tx.config)
}
...
// applies a query, for example: ApiConfig.QueryXXX(), the query will be executed
